...
///
/// This is similar to [`BoxCloneService`](tower::util::BoxCloneService) except the resulting
/// service implements [`Sync`].
///
/// # Warning
///
/// This implementation has been borrowed from this [PR](https://github.com/tower-rs/tower/pull/777).
/// When the PR will be merged and released we will remove this module in favor of the one in Tower.
